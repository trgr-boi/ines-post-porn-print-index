/**
 * Shared modal logic — used by both index.html and images.html.
 * Provides openImageModal / closeModal / getCoverImage / getAllImages.
 *
 * Must be loaded before the page-specific script (show_image.js or images.js).
 */
